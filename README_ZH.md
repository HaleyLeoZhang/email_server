# Go Gin Example [![rcard](https://goreportcard.com/badge/email_server)](https://goreportcard.com/report/email_server) [![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/email_server) [![License](http://img.shields.io/badge/license-mit-blue.svg?style=flat-square)](https://raw.githubusercontent.com/HaleyLeoZhang/email_server/master/LICENSE)
...
创建一个 `blog` 数据库，并且导入建表的 [SQL](https://email_server/blob/master/docs/sql/blog.sql)
...
[GIN-debug] GET    /auth                     --> email_server/routers/api.GetAuth (3 handlers)
[GIN-debug] GET    /swagger/*any             --> email_server/vendor/github.com/swaggo/gin-swagger.WrapHandler.func1 (3 handlers)
[GIN-debug] GET    /api/v1/tags              --> email_server/routers/api/v1.GetTags (4 handlers)
[GIN-debug] POST   /api/v1/tags              --> email_server/routers/api/v1.AddTag (4 handlers)
[GIN-debug] PUT    /api/v1/tags/:id          --> email_server/routers/api/v1.EditTag (4 handlers)
[GIN-debug] DELETE /api/v1/tags/:id          --> email_server/routers/api/v1.DeleteTag (4 handlers)
[GIN-debug] GET    /api/v1/articles          --> email_server/routers/api/v1.GetArticles (4 handlers)
[GIN-debug] GET    /api/v1/articles/:id      --> email_server/routers/api/v1.GetArticle (4 handlers)
[GIN-debug] POST   /api/v1/articles          --> email_server/routers/api/v1.AddArticle (4 handlers)
[GIN-debug] PUT    /api/v1/articles/:id      --> email_server/routers/api/v1.EditArticle (4 handlers)
[GIN-debug] DELETE /api/v1/articles/:id      --> email_server/routers/api/v1.DeleteArticle (4 handlers)
